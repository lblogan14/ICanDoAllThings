...
Description: This module contains all prompt templates used across the research workflow components,
including user clarification, research brief generation, and report synthesis.
"""


# Prompt for determining if user clarification is needed
...
# Prompt for transforming messages into a detailed research topic
...
# Prompt for evaluating if a research brief captures user criteria
...
# Prompt for evaluating if a research brief contains unwarranted assumptions
...
# Prompt for summarizing a webpage
...
# Prompt for compressing research findings - human message
...
# Prompt for the lead researcher / research supervisor
