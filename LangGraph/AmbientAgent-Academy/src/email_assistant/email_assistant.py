...
from email_assistant.prompts import (
    ...
    agent_system_prompt, 
    default_background, default_triage_instructions, default_response_preferences, default_cal_preferences
)
...
def triage_router(state: State) -> Command[Literal['response_agent', '__end__']]:
    ...
    The triage step prevents the agent from wasting time on
    ...
    if classification == 'respond':
        ...
        # In a real app, would send notification to user here
